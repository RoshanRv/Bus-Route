  ...
  const getNearByStop = async () => {
    try {
      const stops = await axios.get<StopProps>(
        `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${coords.latitude},${coords.longitude}&type=bus_station&language=${lang}&key=AIzaSyBfrPEW9qYnBX_tCYROUl4qGP0teAWu5GQ`
      );
